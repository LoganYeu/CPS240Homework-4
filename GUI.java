...
public class GUI extends Application {
    ...
    /* declear operator button
     * Unicode list: \u00d7: MUL \u00f7: DIV */
    protected Button[] operators = {new Button("="), new Button("+"), new Button("-"), new Button("\u00d7"), new Button("\u00f7"), new Button("C"), new Button("DEL"), new Button("%")};


    /* declear result and operation textField */
    ...
    public void start(Stage primaryStage) {
        ...
        paneMiddle.add(operators[5], 0, 0);
        paneMiddle.add(operators[6], 1, 0);
        paneMiddle.add(operators[7], 2, 0);
        ...
        primaryStage.setTitle("Calcuator"); // Set the stage title
